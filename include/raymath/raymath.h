//
// Created by technicjelle on 7/19/23.
//

#ifndef MINI_CRAFT_RAYMATH_H
#define MINI_CRAFT_RAYMATH_H
...
RMAPI Vector3Int Vector3IntZero(void)
{
...
// Check whether two int vectors are equal
RMAPI int Vector3IntEquals(Vector3Int v1, Vector3Int v2)
{
